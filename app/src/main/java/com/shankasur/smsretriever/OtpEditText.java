...
public class OtpEditText extends TextInputEditText {
    ...
    public void setOnOtpCompleteListener(OnOtpCompleteListener onOtpCompleteListener) {
        this.otpCompleteListener = onOtpCompleteListener;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (textLength == mNumChars) {
            otpCompleteListener.onOtpComplete(text.toString());
        }
    }
